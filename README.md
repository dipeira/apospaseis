...
* τέλος σχολικού έτους (για υπολογισμό υπηρεσίας): av_endofyear = "31/08/2015";
* έτος αιτήσεων: av_etos = "2015";
* σχολικό έτος: av_sxoletos = "2014-15";
...
* Ο διαχειριστής μπορεί να αναιρέσει την υποβολή: av_canundo = 1;
* Ο διαχειριστής μπορεί να αλλάξει την οργανική και τη συνολική υπηρεσία του εκπ/κού: av_canalter = 1;
