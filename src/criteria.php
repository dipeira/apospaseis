...
<?php
    ...
    if ($has_aitisi)
    {
        ...
        else
        {
            ...
            if ($org_eid)
                echo "<tr><td colspan=7><input type='checkbox' name='org_eid' value='1' checked ".($is_readonly ? "disabled" : "").">Έχω οργανική στην ειδική αγωγή (σε Ειδικό σχολείο ή τμήμα ένταξης) ή έχω αποσπαστεί μέσω Υ.ΠΑΙ.Θ.Α. στην ειδική αγωγή.</td></tr>";
            else
                echo "<tr><td colspan=7><input type='checkbox' name='org_eid' value='1' ".($is_readonly ? "disabled" : "").">Έχω οργανική στην ειδική αγωγή (σε Ειδικό σχολείο ή τμήμα ένταξης) ή έχω αποσπαστεί μέσω Υ.ΠΑΙ.Θ.Α. στην ειδική αγωγή.</td></tr>";
            ...
            echo "<input class='form-control' size=30 name='dhmos_anhk' ".($is_readonly ? 'disabled' : '')." value=$dhmos_anhk >";
            echo "</td></tr>";
            echo "<tr><td colspan=7>Εντοπιότητα</td></tr>";
            echo "<tr><td colspan=2>Δήμος της Περιφερειακής Ενότητας $av_nomos που έχω εντοπιότητα</td><td colspan=5>";
            ...
            echo "</td></tr>";
            if ($eidikh)
                echo "<tr><td colspan=2>Ειδική Κατηγορία (κατά προτεραιότητα)</td><td colspan=5><input type='checkbox' name='eidikh' value='1' checked ".($is_readonly ? "disabled" : "").">Επιθυμώ να υπαχθώ σε ειδική κατηγορία αποσπάσεων</td></tr>";
            else
                echo "<tr><td colspan=2>Ειδική Κατηγορία (κατά προτεραιότητα)</td><td colspan=5><input type='checkbox' name='eidikh' value='1' ".($is_readonly ? "disabled" : "").">Επιθυμώ να υπαχθώ σε ειδική κατηγορία αποσπάσεων</td></tr>";
            ...
            echo "</td></tr>";
            if ($eksw)
                echo "<tr><td colspan=2>Θεραπεία για εξωσωματική γονιμοποίηση</td><td colspan=5><input type='checkbox' name='eksw' value='1' checked ".($is_readonly ? "disabled" : "")."></td></tr>";
            else
                echo "<tr><td colspan=2>Θεραπεία για εξωσωματική γονιμοποίηση</td><td colspan=5><input type='checkbox' name='eksw' value='1' ".($is_readonly ? "disabled" : "")."></td></tr>";
            echo "<tr><td colspan=2>Σχόλια - Παρατηρήσεις</td><td colspan=5><textarea class='form-control' cols=60 name='comments' ".($is_readonly ? "readonly" : "").">$comments</textarea></td></tr>";
            ...
            if ($ypdil)
                echo "<tr><td colspan=7><input type='checkbox' name='ypdil' value='1' checked ".($is_readonly ? "disabled" : "").">$blabla</td></tr>";
            else
                echo "<tr><td colspan=7><input type='checkbox' name='ypdil' value='1' ".($is_readonly ? "disabled" : "").">$blabla</td></tr>";
    ...
    else
    {
        ...
        cmbPaidia();
        echo "</td><td>Δήμος</td><td>";
        echo "<input size=30 name='dhmos_anhk' ".($is_readonly ? "readonly" : "").">";
        echo "</td><td></td></tr>";
        echo "<tr><td colspan=7>Εντοπιότητα</td></tr>";
        echo "<tr><td colspan=2>Δήμος της Περιφερειακής Ενότητας $av_nomos που έχω εντοπιότητα</td><td colspan=5>";
        ...
        echo "</td></tr>";
        echo "<tr><td colspan=2>Θεραπεία για εξωσωματική γονιμοποίηση</td><td colspan=5><input type='checkbox' name='eksw' value='1' ".($is_readonly ? "disabled" : "")."></td></tr>";
        echo "<tr><td colspan=2>Σχόλια - Παρατηρήσεις</td><td colspan=5><textarea cols=60 name='comments' value='$comments' ".($is_readonly ? "readonly" : "")."></textarea></td></tr>";        
        $blabla = "Δηλώνω υπεύθυνα ότι δεν έχω οριστεί στέλεχος εκπαίδευσης (λ.χ. προϊστάμενος/μένη ολιγοθέσιας σχολικής μονάδας, διευθυντής/ντρια σχολ. μονάδας) και ότι δεν υπηρετώ σε θέση με θητεία που λήγει μετά τις 31-08-$av_etos.";
        echo "<tr><td colspan=7><input type='checkbox' name='ypdil' value='1' ".($is_readonly ? "disabled" : "").">$blabla</td></tr>";
