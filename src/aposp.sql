...
(1, 'av_is_active', '1', 'Σύστημα ενεργό', 1),
(2, 'av_type', '1', 'Λειτουργία εφαρμογής', 0),
...
(12, 'av_active_from', 'Τρίτη 24/07/2018', 'Ενεργό από', 0),
(13, 'av_active_to', 'Τρίτη 24/07/2018', 'Ενεργό έως', 0),
(14, 'av_auto_disable', '0', 'Αυτόματη απενεργοποίηση μετά την ημερομηνία λήξης', 1),
(15, 'av_endofyear', '31/08/2017', 'Τέλος σχολικού έτους (για υπολογισμό υπηρεσίας)', 0),
(16, 'av_etos', '2018', 'Έτος αιτήσεων (ημερολογιακό)', 0),
(17, 'av_sxoletos', '2017-18', 'Σχολικό έτος', 0),
(18, 'av_extra', '0', 'Εισαγωγή επιπλέον πεδίου για είσοδο στο σύστημα', 1),
(19, 'av_extra_name', ' ', 'Όνομα επιπλέον πεδίου', 0),
(20, 'av_extra_label', ' ', 'Επικεφαλίδα επιπλέον πεδίου', 0),
(21, 'av_link', ' ', 'Σύνδεσμος εγκυκλίου (εμφανίζεται στη βοήθεια της εφαρμογής)', 0),
