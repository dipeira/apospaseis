...
(14, 'av_active_to_time', '15:00', 'Ενεργό έως ώρα', 0),
(15, 'av_auto_disable', '0', 'Αυτόματη απενεργοποίηση μετά την ημερομηνία λήξης', 1),
...
(24, 'av_canundo', '1', 'Ο διαχειριστής μπορεί να αναιρέσει την υποβολή', 1),
(25, 'av_canalter', '1', 'Ο διαχειριστής μπορεί να αλλάξει την οργανική και τη συνολική υπηρεσία του εκπ/κού', 1),
(26, 'criteria_lock', '0', 'Κλείδωμα κριτηρίων απόσπασης', 1);
