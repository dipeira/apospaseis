...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Roboto+Condensed:400,400italic&subset=greek,latin'
            ...
            elseif ($_GET['action'] == "export" || $_GET['action'] == "export_eid") {
                ...
                if ($num == 0) {
                    if ($count_ait > 0) {
                        ...
                        $debug_errors = get_export_debug_info($mysqlconnection, $av_type, $andClause);
                        if (count($debug_errors) > 0) {
                            echo "<br><b>Λεπτομέρειες σφαλμάτων διάγνωσης:</b><br><ul><li>" . implode("</li><li>", $debug_errors) . "</li></ul>";
                        }
                        echo "</div>";
                    } else {
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <?php if ($av_type == 1): ?>
                                        <a class="dropdown-item" href="admin.php?action=eidiki">Αιτήσεις στην Ειδική αγωγή (από τη
                                            Γενική αγωγή ή από την Ειδική αγωγή)</a>
                                        <?php
                                    endif;
                                    if ($av_type == 1):
                                        ?>
                                        <a class="dropdown-item" href="admin.php?action=export">Από τη Γενική στη Γενική (για
                                            πρόγραμμα PPYSDE)</a>
                                    </div>
                                    <?php
